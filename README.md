# Single layer neural network model analysis with respective different activation function for prediction as per various datasets (Bank-Note, Iris, Wisconsin Breast Cancer and MNIST)
